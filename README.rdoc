...
Sometimes, you may want to use GitHub API authenticated as a third party, for this use case, you have a couple of options too.

The following examples requires a valid user authenticated with login and API token. This information can be found on our account page (the link is inside the "badge" that is displayed on the upper right corner when you're logged in - the URL is https://github.com/account).

Once you have the login and token you can run authenticated commands using:
